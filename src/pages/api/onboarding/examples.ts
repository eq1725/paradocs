...
var CURATED: Curated[] = [
  ...
  { id: '43514830-2774-44e2-b069-b79f03b153b9', category: 'ghosts_hauntings', short: 'I saw a human figure made of light standing across my basement couch at 11pm.', long: 'Walking to the washroom late one night, I felt a sudden urge to turn around. When I did, I saw a human figure made of light standing on the other side of my couch—not bright, but clearly visible despite my lights being on.' },
  ...
  { id: '9fa84ea4-3567-4390-95a1-7cac59bea815', category: 'ghosts_hauntings', short: "I received a 12-second call from a cemetery's number—the only one I'd ever visited—with only static on the line.", long: "A month after visiting a cemetery for the first time, I received a call displaying that exact cemetery's number. When I answered, there was only silence and static before the line went dead after 12 seconds. The number doesn't exist when I try to call back." },
  { id: '2dc29476-3253-4a1c-9272-c1bd4dd4dbdd', category: 'religion_mythology', short: 'Fevered and half-asleep on Lunar New Year Eve, I felt myself float weightlessly above my body, dancing like Peter Pan.', long: 'On Lunar New Year Eve, fevered and half-asleep in bed, I felt myself leave my body and float weightlessly above it. I danced like Peter Pan on the bed rail, spinning on tiptoes. While floating, I could see through the ceiling to the living room below, where my family played Mahjong—everything felt vivid and real, not like a dream.' },
