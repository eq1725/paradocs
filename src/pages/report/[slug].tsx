...
import { logActivity } from 'A/lib/services/streak.service'
...
const PatternConnections = dynamic(
  () => import('A/components/reports/PatternConnections'),
...
const EnvironmentalContext = dynamic(
  () => import('A/components/reports/EnvironmentalContext'),
...
import OnboardingTour, { hasCompletedOnboarding } from 'A/components/OnboardingTour'
    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 py-4 sm:py-8">
        ...
        <nav className="flex items-center gap-1.5 text-sm text-gray-400 mb-6 overflow-hidden">
          ...
          <ChevronRight className="v-3.5 h-3.5 shrink-0 text-gray-600" />
        ...
        <div className="sticky bottom-0 z-40 -mx-3 sm:-mx-4 px-3 sm:px-4 py-3 bg-black/80 backdrop-blur-md border-t border-white/10 mb-6 sm:mb-8">
            <div className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-3 sm:gap-4">
                ...
                >
                  <MessageCircle className="w-4 h-4 sm:w-5 sm:h-5" />                <span className="text-sm">{comments.length}</span>
              </button>
            </div>
