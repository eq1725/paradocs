 ...
 *
 * V11.17.4 — Replaced the static SVG mock with a real screen
 * recording of the global map (`public/showcase/map.mp4`).
 * The video autoplays, mutes, loops, and plays-inline on iOS.
 * The static dot mockup is preserved as a `<video>` fallback —
 * if the file fails to load or the browser can't render it, the
 * fallback renders.
 */
...
export default function MapShowcase() {
  ...
  // to the static dot mockup. State flip happens in <video onError>.
    ...
    <section className="py-16 md:py-24 border-t border-white/5 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="flex flex-col md:flex-row items-center md:items-start gap-10 md:gap-14">
          ...
          <div className="flex-shrink-0 order-2 md:order-2 md:-my-16">
            <PhoneMockup>
              {!videoFailed ? (
                <video
                  autoPlay
                  ...
                  playsInline
                  preload="metadata"
                  aria-label="Demo of the Paradocs global map showing report clusters"
                ...
                <div className="absolute inset-0 bg-[#0a0f1a]">
                  {/* Static fallback — faint landmass suggestions */}
                  ...
                  {/* Static map UI overlays — preserved as fallback */}
