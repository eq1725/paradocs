 ...
 * QR code image must exist at /qr-paradocs.png in public folder.
 */
    ...
    <div className="flex items-center gap-4 sm:gap-6">
      ...
      <div className="flex flex-col gap-2">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-4 py-2 bg-black rounded-lg border border-white/20 hover:border-white/40 transition-colors"
        >
