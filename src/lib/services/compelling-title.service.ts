...
var SYSTEM_PROMPT = [
  ...
  '- The headline MUST lead with the phenomenon, action, or specific concrete detail.',
  '  NOT with a role noun. Lead with WHAT happened or WHAT was seen, not WHO observed it.',
  '- BANNED LEAD-INS: any title starting with "Witness Reports X", "Researcher Struggles With X",',
  '  "Seeker Pursues X", "Practitioner Describes X", "Medium Reports X", "Meditator Describes X",',
  '  "Poster Receives X", "Subject Encounters X", or any variant matching',
  '  (Witness|Researcher|Seeker|Practitioner|Medium|Meditator|Poster|Subject|User|Reader|',
  '  Listener|Viewer|Investigator|Skeptic|Believer|Experiencer|Patient|Student|Tourist|',
  '  Traveler|Visitor|Local|Resident|Anonymous) + (reports|describes|recounts|sees|saw|',
  '  seeks|encounters|claims|shares|struggles|wonders|pursues|finds|gets|receives).',
  '  These read like news copy ABOUT a witness, not the experience itself.',
  '- Role nouns ("Woman", "Man", "Child", "Teen", "Driver", "Hiker") are OK ONLY when they',
  '  carry essential context (e.g. "Child Sees Hat Man at Foot of Bed" — child-vs-adult',
  '  matters there). Otherwise lead with the phenomenon.',
  '',
  'GOOD examples (lead with the phenomenon / entity / event):',
  '  - "Pale Crawler Appears at Bedroom Window"',
  '  - "Synchronicity Patterns Span Two Decades"',
  '  - "DMT Entity Encounter Halts Breakthrough"',
  '  - "Recurring Shadow Visions During Insomnia"',
  '',
  'BAD examples (lead with a role noun + reporting verb — DO NOT produce these):',
  '  - "Witness Reports Pale Crawler at Window"',
  '  - "Researcher Struggles With DMT Breakthrough Threshold"',
  '  - "Medium Reports Sudden Blinding White Light Vision"',
  '',
  ...
  '  and youtube channel names. When you must refer to the experiencer (only when it adds',
  '  essential context per the rule above), use generic role nouns: "Woman", "Man", "Child",',
  '  "Teen", "Rancher", "Nurse", "Driver", "Patient", etc.',
