...
var SYSTEM_PROMPT = ANTI_FABRICATION_PREAMBLE
  ...
  + '  * "creates a state where perception shifts" → "her thinking changed" or "her senses sharpened"\n'
  + '  * "the relationship between intention and outcome" → "what she wanted and what happened next"\n'
  ...
  + '  * "perceptual experience" → "what she saw" / "what she felt"\n'
  + '  * "the experiencer reports that…" → "she said…" or "the witness said…"\n'
  ...
  + '- WRITE LIKE A FRIEND TELLING A STORY, not like a paper. A friend says "She was meditating in '
  + 'her room when something changed" — not "The witness entered a meditative state during which '
